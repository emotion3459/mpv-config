...
for %%a in %scripts% do powershell -Command "Invoke-WebRequest -Uri %%a -OutFile "%scripts_dir%%%~nxa""
for %%a in %shaders% do powershell -Command "Invoke-WebRequest -Uri %%a -OutFile "%shaders_dir%%%~nxa""
